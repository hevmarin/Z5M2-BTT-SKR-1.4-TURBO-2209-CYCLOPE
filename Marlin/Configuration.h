...
#define STRING_CONFIG_H_AUTHOR "(DEF_HMC_2_2024, SKR V1.4 Turbo TMC2209))" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "def_Z5M2 BTT SKR 1.4 2Turbo HMC"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -5, -2 }
